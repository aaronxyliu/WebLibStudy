# Calculate the number of hits of each group in different years
...
if __name__ == '__main__':
    ...
    hits_cat_lists = [[]] * group_num

    for i in range(group_num):
        hits_cat_lists[i] = analyze(GROUP_LIST[i])
    hits_cat_lists.append(analyze('Total', total=True))
    
    with open(f'data/hitstrend/byGroup.csv', 'w', newline='') as file:
